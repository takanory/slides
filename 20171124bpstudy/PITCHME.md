...
* 最初に知ってもらいたい内容を凝縮
* これからPythonを仕事のために習得するエンジニア
* 仕事で役立つポイントをつまみ食い
* 他のプログラミング言語知っている前提(Python入門ではない)
...
* Python 2.7 → 3.6、他各種バージョンアップ
* 第4章「スクレイピング」書き下ろし
* 第5章「PyData入門ガイド」大幅に構成変更(ほぼ書き下ろし)
* 第6章「Webアプリケーション開発」でBottle→Django(ほぼ書き下ろし)
